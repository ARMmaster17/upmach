...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post machines_url, params: { machine: { manufacturer: @machine.manufacturer, model: @machine.model, name: @machine.name } }
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { manufacturer: @machine.manufacturer, model: @machine.model, name: @machine.name } }
